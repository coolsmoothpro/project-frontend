...
import { currentUser, updateUser, updatePassword } from '../../Api/auth';
                        ...
                        <div className="d-grid gap-3 gap-lg-5">
                            ...
                            <div className="card">
                                ...
                                <div className="profile-cover">
                                    <div className="profile-cover-img-wrapper">
                                        ...
                                        <div className="profile-cover-content profile-cover-uploader p-3">
                                            <input type="file" className="js-file-attach profile-cover-uploader-input" id="profileCoverUplaoder"/>
                                ...
                                <label className="avatar avatar-xxl avatar-circle avatar-uploader profile-cover-avatar" htmlFor="editAvatarUploaderModal">
                                    <img id="editAvatarImgModal" className="avatar-img" src={avatar || AVATAR} alt="Image Description" />
                                ...
                                <div className="card-body">
                                    ...
                                    <form>
                                        ...
                                        <div className="row mb-4">
                                            ...
                                            <div className="col-sm-9">
                                                <div className="input-group input-group-sm-vertical">
                                                    <input value={firstname} onChange={(e) => setFirstName(e.target.value)} type="text" className="form-control" name="firstName" id="firstNameLabel" placeholder="Your first name" aria-label="Your first name" defaultValue="Mark" />
                                                    <input value={lastname} onChange={(e) => setLastName(e.target.value)} type="text" className="form-control" name="lastName" id="lastNameLabel" placeholder="Your last name" aria-label="Your last name" defaultValue="Williams" />
                                                </div>
                                            </div>
                                        </div>
                                        {/* End Form */}
                                        ...
                                        <div className="row mb-4">
                                            ...
                                            <div className="col-sm-9">
                                                <input value={email} onChange={(e) => setEmail(e.target.value)} type="email" className="form-control" name="email" id="emailLabel" placeholder="Email" aria-label="Email" defaultValue="mark@site.com" />
                                            </div>
                                        </div>
                                        {/* End Form */}
                                        {/* Form */}
                                        <div className="row mb-4">
                                            ...
                                            <div className="col-sm-9">
                                                <input value={phone || ""} onChange={(e) => setPhone(e.target.value)} type="text" className="js-input-mask form-control" name="phone" id="phoneLabel"  />
                                            </div>
                                        </div>
                                        {/* End Form */}
                                        {/* Form */}
                                        <div className="row mb-4">
                                            ...
                                            <div className="col-sm-9">
                                                <input value={organization || ""} onChange={(e) => setOrganization(e.target.value)} type="text" className="form-control" name="organization" id="organizationLabel" placeholder="Your organization" aria-label="Your organization" defaultValue="Htmlstream" />
                                            </div>
                                        </div>
                                        {/* End Form */}
                                        {/* Form */}
                                        <div className="row mb-4">
                                            ...
                                            <div className="col-sm-9">
                                                <input value={department || ""} onChange={(e) => setDepartment(e.target.value)} type="text" className="form-control" name="department" id="departmentLabel" placeholder="Your department" aria-label="Your department" />
                                            </div>
                                        </div>
                                        {/* End Form */}
                                        {/* Form */}
                                        ...
                                        <div className="row mb-4">
                                            ...
                                            <div className="col-sm-9">
                                                <input value={address1} onChange={(e) => setAddress1(e.target.value)} type="text" className="form-control" name="addressLine1" id="addressLine1Label" placeholder="Your address" aria-label="Your address" defaultValue="45 Roker Terrace, Latheronwheel" />
                                            </div>
                                        </div>
                                        {/* End Form */}
                                        {/* Form */}
                                        <div className="row mb-4">
                                            ...
                                            <div className="col-sm-9">
                                                <input value={address2} onChange={(e) => setAddress2(e.target.value)} type="text" className="form-control" name="addressLine2" id="addressLine2Label" placeholder="Your address" aria-label="Your address" />
                                            </div>
                                        </div>
                                        {/* End Form */}
                                        {/* Form */}
                                        <div className="row mb-4">
                                            ...
                                            <div className="col-sm-9">
                                                <input value={zipcode} onChange={(e) => setZipCode(e.target.value)} type="text" className="js-input-mask form-control" name="zipCode" id="zipCodeLabel" placeholder="Your zip code" />
                                            </div>
                                        </div>
                                        {/* End Form */}
